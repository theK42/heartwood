...
namespace AYellowpaper.SerializedCollections.KeysGenerators
{
    public class KeyListGeneratorSelectorWindow : EditorWindow
    {
        ...
        {
            VisualTreeAsset document = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Packages/com.thek42.heartwood/ThirdParty/SerializedDictionary/Editor/Assets/KeysGeneratorSelectorWindow.uxml");
