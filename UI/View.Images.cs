...
namespace Heartwood.UI
{
    public partial class View
    {
        ...
        // reassigned or cancelled independently, and are all released in CleanupImages.
        private readonly Dictionary<string, ImageSlot> _imageSlots = new();

        // Called from OnDestroy in the main partial. Every image slot cancels its
        // in-flight CTS and releases its Addressables handle.
